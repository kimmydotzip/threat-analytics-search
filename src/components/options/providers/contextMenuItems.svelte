<script>
  ...
  export async function initProvidersAndGroups() {
    ...
    groups =
      (await LocalStore.getOne(StoreKey.SETTINGS))?.providersGroups || [];
  }
            ...
            <div class="d-flex align-items-start">
              <div class="flex-1">
                <input
                  ...
                  on:change={(e) => onChange(index, "label", e.target.value)}
                />
              ...
              <div class="flex-2 mx-2">
                <input
                  ...
                  on:change={(e) => onChange(index, "link", e.target.value)}
                />
            ...
            {#if item.proxyEnabled}
              <div class="mt-2 d-flex align-items-center">
                ...
                <input
                  ...
                  on:change={(e) => onChange(index, "proxyUrl", e.target.value)}
                />
              </div>
            {/if}
